...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public DatabaseHelper(Context context) {
        ...
        DB_PATH = "/data/data/" + context.getPackageName() + "/"+DB_NAME;
        initialize();
    }
    ...
    public void initialize() {
        ...
        if (dbExists) {
            ...
            // create table!
            db.execSQL("CREATE TABLE " + TABLE_NAME + "(_id REAL, name TEXT, attribute TEXT, easy REAL, easybondlp REAL, normal REAL, normalbondlp REAL, hard REAL, hardbondlp REAL, expert REAL, expertbondlp REAL);");

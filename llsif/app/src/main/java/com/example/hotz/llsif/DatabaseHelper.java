...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void initialize (){
        ...
        if (dbExists){
            ...
            // create table!
            db.execSQL("CREATE TABLE IF NOT EXISTS" + TABLE_NAME + "(_id REAL, name TEXT, attribute TEXT, easy REAL, easybondlp REAL, normal REAL, normalbondlp REAL, hard REAL, hardbondlp REAL, expert REAL, expertbondlp REAL);");
